...
const App = ({ navigation }) => {
  ...
  /**
   * Hooks for param to tab navigator
   */
  const [paramNavigator, setParamNavigator] = useState();
...
useEffect(() => {
  ...
  return (
    <AppContext.Provider value={{ authContext, response, dmResponse, chat, paramNavigator, setParamNavigator }}>
      <NavigationContainer>
        <Routes />
      </NavigationContainer>
    </AppContext.Provider>
